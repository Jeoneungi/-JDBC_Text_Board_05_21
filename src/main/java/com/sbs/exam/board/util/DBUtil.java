...
public class DBUtil {
  public static Map<String, Object> selectRow(Connection conn, SecSql sql) {
  ...
  public static List<Map<String, Object>> selectRows(Connection conn, SecSql sql) throws SQLErrorException {
    ...
    try {
      stmt = sql.getPreparedStatement(conn);
